...
*/
exports.showNumbers = function(numero) {
...
*/
exports.showPairNumbers = function(numero) {
...
*/
exports.filterPairNumbers = function(numeros) {

    return numeros.filter(function(valor) {
        return valor % 2 == 0;
    });
}
